...
<div style="position: relative; z-index: 2;">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-header bg-custom-maroon text-white">
            <h4 class="card-title card-title-center">Manajemen Ruangan</h4>
            <a href="{{ route('ruangan.create') }}" class="btn btn-light btn-sm float-end">
        ...
        <div class="card-body">
            ...
            <div class="row">
                @forelse ($ruangan as $room)
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 card-animated" style="animation-delay: {{ $loop->index * 0.05 }}s;">
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-body text-center d-flex flex-column">
                                ...
                                <div class="mt-auto pt-3">
                                    <hr>
                                    <a href="{{ route('ruangan.edit', $room->id) }}" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>

                                    <form action="{{ route('ruangan.destroy', $room->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus ruangan ini?');">
                                        @csrf
                                        @method('DELETE')
